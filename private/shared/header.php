...
<body>
    <nav class="navbar navbar-expand-sm navbar-light border-bottom py-md-3 mb-3" style="background:#fff">
        <section class="container">
                ...
                <div class="collapse navbar-collapse" id="ny_navbar">
                    <div class="navbar-text mr-4"><?php echo current_user_location();?></div>
                    ...
                    <?php if($session->isLoggedIn()): ?>
                        <div class="navbar-nav ml-auto">                            
                            ...
                            <a class="btn btn-outline-success ml-4" href="new.php">Add your Property</a>
                        </div>
                    <?php else: ?>  
                        <div class="navbar-nav ml-auto">
                            <a class="btn btn-outline-success mr-4" href="new.php">Add your Property</a>
