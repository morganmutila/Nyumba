...
START TRANSACTION;
USE `nyumba_yanga`;
INSERT INTO `nyumba_yanga`.`property` (`id`, `user_id`, `location_id`, `address`, `beds`, `baths`, `terms`, `size`, `units`, `type`, `price`, `negotiable`, `description`, `cphoto`, `added`, `owner`, `contact_number`, `contact_email`, `available`, `views`, `reference`, `status`, `listed_by`, `market`, `flags`) VALUES (1, 3, 1, '333627/1080', 3, 1.5, '1', '564', 1, 'House', '7500.00', 0, 'Its very beautiful house', '', '2019-05-08 14:23:07', 'Morris Mutila', '0976249140', 'mutilamorgan@gmail.com', '2019-05-11', 22, '955374150', 2, '1', 'rent', 0);
INSERT INTO `nyumba_yanga`.`property` (`id`, `user_id`, `location_id`, `address`, `beds`, `baths`, `terms`, `size`, `units`, `type`, `price`, `negotiable`, `description`, `cphoto`, `added`, `owner`, `contact_number`, `contact_email`, `available`, `views`, `reference`, `status`, `listed_by`, `market`, `flags`) VALUES (2, 2, 4, '126D67', 2, 2, '', '306', 1, 'Apartment', '20000.00', 1, 'Beautiful environment', '', '2019-05-08 14:28:07', 'Sharon Bunda', '0978348845', 'mowa@gmail.com', '2019-05-15', 4, '173663274', 2, '1', 'sale', 0);
INSERT INTO `nyumba_yanga`.`property` (`id`, `user_id`, `location_id`, `address`, `beds`, `baths`, `terms`, `size`, `units`, `type`, `price`, `negotiable`, `description`, `cphoto`, `added`, `owner`, `contact_number`, `contact_email`, `available`, `views`, `reference`, `status`, `listed_by`, `market`, `flags`) VALUES (3, 5, 6, '4356363tr', 1, 1, '3', '768', 1, 'Apartment', '1500.00', 0, 'Its big and beautiful', '', '2019-05-08 20:21:46', 'Sharon Bunda', '0978348845', 'mowa@gmail.com', '2019-05-09', 2, '2111013844', 2, '1', 'rent', 0);
INSERT INTO `nyumba_yanga`.`property` (`id`, `user_id`, `location_id`, `address`, `beds`, `baths`, `terms`, `size`, `units`, `type`, `price`, `negotiable`, `description`, `cphoto`, `added`, `owner`, `contact_number`, `contact_email`, `available`, `views`, `reference`, `status`, `listed_by`, `market`, `flags`) VALUES (4, 3, 7, '8767R45', 3, 2, '', '564', 1, 'Town House', '350000.00', 1, 'Its beautiful and neat ', '', '2019-05-08 20:25:08', 'Morris Mutila', '0976249140', 'mutilamorgan@gmail.com', '2019-05-15', 1, '1630895609', 2, '1', 'sale', 0);
INSERT INTO `nyumba_yanga`.`property` (`id`, `user_id`, `location_id`, `address`, `beds`, `baths`, `terms`, `size`, `units`, `type`, `price`, `negotiable`, `description`, `cphoto`, `added`, `owner`, `contact_number`, `contact_email`, `available`, `views`, `reference`, `status`, `listed_by`, `market`, `flags`) VALUES (5, 1, 3, '2 bedroomed house', 1, 1, '', '300', 1, 'House', '6000.00', 0, 'Small but its very nice and neat', '', '2019-05-13 12:38:43', 'Agness Chola', '0965574533', 'agnes@gmail.com', '2019-05-15', 2, '1052098018', 2, '1', 'sale', 0);
