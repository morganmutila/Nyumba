...
<div class ="properties">
	<?php foreach ($properties_2 as $property_2):?>
		<div style=" margin: 20px 0 2rem 0;">
			<?php 				
				echo "<strong style=\"letter-spacing: 0.07rem;font-size:1.15rem;\">".amount_format($property_2->price)."<small>".$property_2->rentTerms()."</small></strong>";
				if(isset($user)){
...
<div class ="properties">
	<?php foreach ($properties as $property):?>
		...
		<div style=" margin: 10px 0 2rem 0;">
			<?php 			
				echo "<strong style=\"letter-spacing: 0.07rem;font-size:1.15rem;\">".amount_format($property->price)."<small>".$property->rentTerms()."</small></strong>";
				if(isset($user)){
